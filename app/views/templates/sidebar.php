        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= BASE_URL  ?>admin_pengguna">Pengguna</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Pilihan :</h6>
                        <a class="collapse-item" href="<?= BASE_URL  ?>admin_transaksi">Transaksi</a>
                        <a class="collapse-item" href="<?= BASE_URL  ?>admin_pembayaran">Pembayaran</a>
                        <a class="collapse-item" href="<?= BASE_URL  ?>admin_entry">Entry Pembayaran</a>
                    </div>
                </div>
            </li>
        </ul>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="<?=BASE_URL?>/logout" onclick="return confirm('yakin?')">
